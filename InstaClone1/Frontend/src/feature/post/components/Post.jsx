    ...
    <div>
        <div className="post">
                        ...
                        <img src={user?.profilePic} alt="" />
                            ...
                            <button
                            id={postOwnerUsername === currentUser?.username ? "disabled-follow-btn" : ""}
                            className={post.isFollowing ? "following" : "follow"} disabled={postOwnerUsername === currentUser?.username} onClick={() => {post.isFollowing ? handleUnFollowUser(user.username) : handleFollowUser(user.username)}}>
                    ...
                    <div className="icons">
                        <div className="left">
                            <button 
                            onClick={() => {post.isLiked? handleLikePost(post._id): handleUnLikePost(post._id)}}
                            >
                            {post.isLiked ? (
                                <svg className='like' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"><path d="M2 8.5C2 5.46243 4.46243 3 7.5 3C9.36016 3 11.0046 3.92345 12 5.33692C12.9954 3.92345 14.6398 3 16.5 3C19.5376 3 22 5.46243 22 8.5C22 16 11.9999 21.4852 11.9999 21.4852C11.9999 21.4852 2 16 2 8.5Z"></path></svg>) : (
                    ...
                    <div className="bottom">
                        <p className="captionn">{post.caption}</p>
                    </div>
                    </div>
    </div>
  )
